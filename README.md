# [React Kanban Board - Task Tracker with Compact View](https://react-kanban-board-js.vercel.app/)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Shorabh-Singh/React-Kanban-Board.js
   ```
...
- **Name:** Shorabh Singh
- **Email:** [sshorabhsingh@gmail.com](mailto:sshorabhsingh@gamil.com)
